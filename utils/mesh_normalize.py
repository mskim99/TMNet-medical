...
mesh = meshio_custom.read_obj('./data/sphere2562.obj')
...
normals_origin = normals_origin / normals_origin_len.re
shape(-1, 1)

mesh = meshio_custom.write_obj('./data/sphere2562_norm.obj', points_origin, faces_origin, None, normals_origin)
